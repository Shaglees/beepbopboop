...
type FeedbackData struct {
	...
	Reason       string           `json:"reason,omitempty"` // optional transparency note
	Options      []FeedbackOption `json:"options,omitempty"` // for poll/survey
	MinValue     *float64         `json:"min_value,omitempty"` // for rating
	MaxValue     *float64         `json:"max_value,omitempty"` // for rating
	Questions    []SurveyQuestion `json:"questions,omitempty"` // for survey
}
