...
func main() {
	...
	saveRepo := repository.NewSaveRepo(db)
	...
	multiFeedH := handler.NewMultiFeedHandler(userRepo, postRepo, userSettingsRepo, weightsRepo, eventRepo, reactionRepo, saveRepo)
	...
	savesH := handler.NewSavesHandler(userRepo, saveRepo)
	...
	r.Group(func(r chi.Router) {
		...
		r.Post("/posts/{postID}/save", savesH.SavePost)
		r.Delete("/posts/{postID}/save", savesH.UnsavePost)
